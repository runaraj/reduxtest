...
//Takes incrementSyncCounter from the import state/counters/action-creators
// and passes it (dispatches) to the PageCounters component via connect() at the end?
